...
const metadata = {
  ...
  interface_hash: "interface-123",
  typed_semantics_hash: "semantics-456",
  types: [
...
assert.equal(derivePlaygroundInspector(metadata, null).interfaceHash, "interface-123");
assert.equal(derivePlaygroundInspector(metadata, null).typedSemanticsHash, "semantics-456");
